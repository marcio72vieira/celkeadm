...
class AdmsAddUsers 
{
    ...
    private function valInput() {
        ...
        //Valida o username se é único no banco de dados. Obs, antes validava a partir do email
    ...
    private function sendEmail() {
        ...
        if($sendEmail->getResultado()) {
            $_SESSION['msg'] = "Usuário cadastrado com sucesso!<br>Necessário acesse a caixa de e-mail para confirmar o e-mail";
            $this->resultado = true;
        } else {
